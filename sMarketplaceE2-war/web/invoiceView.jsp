            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-right">  <% out.print(entry.getKey().getPriceWithDiscount() * entry.getValue()); %> </td>
                    </tr>>
                    <% } %>
                </tbody>
            </table>
            <div class="row text-right">
                ...
                <div class="col-xs-2">
                    <strong>
                        ...
                        <% out.print(invoice.getCart().getPriceDiscounted()); %> €  <br>
                        <% out.print(invoice.getCart().getProductsPriceWithDiscount()); %> €  <br>
                        <% out.print(invoice.getCart().getPriceIncremented()); %> € <br> 
                        <% out.print(invoice.getCart().getPriceWithIncrements()); %> € <br>
                    </strong>
                </div>
            </div>
            <div class="row">
