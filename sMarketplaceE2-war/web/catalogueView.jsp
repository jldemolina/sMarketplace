                    ...
                    <li class="row">
                        <form action="FrontController" method="GET">
                            ...
                            <span class="price"> <% out.println(product.getPrice() + "€");
                                if (product.getPriceWithDiscount() != product.getPrice()) {
                                    out.print(" > " + product.getPriceWithDiscount() + "€");
                                } %> </span>
                        </form> 
                    </li>
                    <% } %>
                ...
                <form action="FrontController" method="GET">
                    <nav>
                        <ul class="pagination">
                            ...
                            <li><button class="btn btn-primary" name="decrease" value="1">&laquo;</button></li>
                            <li><button class="btn btn-primary" name="increase" value="1">&raquo;</button></li>
                        </ul>
                    </nav>
                </form> 
